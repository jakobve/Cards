...
import es.uam.eps.dadm.cards.ui.fragment.CardListFragmentDirections
import es.uam.eps.dadm.cards.R
import es.uam.eps.dadm.cards.databinding.FragmentCardListBinding
import es.uam.eps.dadm.cards.ui.activity.SettingsActivity
import es.uam.eps.dadm.cards.ui.adapter.CardAdapter
import es.uam.eps.dadm.cards.viewModel.CardListViewModel
    ...
    override fun onCreateView(
        ...
        binding.reviewCards.setOnClickListener {
            it.findNavController()
                .navigate(
                    CardListFragmentDirections.actionCardListFragmentToStudyFragment()
                )
        }
