...
import es.uam.eps.dadm.cards.ui.adapter.StatisticsPagerAdapter
...
class StatisticsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val viewPager = findViewById<ViewPager>(R.id.view_pager_statistics)
        val adapter = StatisticsPagerAdapter(supportFragmentManager)
        ...
        val tabLayout = findViewById<TabLayout>(R.id.tab_layout_statistics)
